      ...
      sections: [
        {
          ...
          body: {
            ...
            fr: "Démarrer un projet KMP implique de brancher Koin, Room, Ktor, SKIE et Fastlane depuis zéro ; puis configurer ESLint, Husky, commitlint et Vitest pour le compagnon Angular ; puis monter Spring Security, la validation JWT, les migrations Flyway et un service d'identité. C'est des jours de configuration avant d'écrire une seule ligne de logique métier.\n\nLe problème plus profond : sans structure imposée, chaque projet accumule ses propres conventions. Les imports cross-features s'infiltrent. La pyramide de tests s'effondre. Les décisions qui devraient relever de l'architecture deviennent des accidents du premier sprint.",
          },
          highlight: {
            text: {
  ...
  <text x="286" y="318" fill="var(--mat-sys-on-surface-variant)" font-size="10">Internal path (NetBird VPN)</text>
    ...
    'mesh-companion': {
      ...
      description: {
        ...
        fr: 'Sidecar Go léger pour Traefik. Surveille les événements Docker et synchronise automatiquement les labels de routage Traefik vers DNS Cloudflare (externe), DNS NetBird (interne) et monitors Uptime Kuma, avec DNS split-horizon et observabilité zéro-config sur un cluster multi-nœuds.',
      },
